...
- 2026-06-11: Added an Advanced raw import console helper with an Open PoE Profile link, visible console snippet, and Copy Console Code button. The snippet copies the current PoE page HTML for pasting into Advanced raw import.
