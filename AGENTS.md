...
- 2026-06-11: Added an Advanced raw import console helper with an Open PoE2 Account link (`https://pathofexile2.com/my-account/`), visible console snippet, and Copy Console Code button. The snippet copies the current PoE page HTML for pasting into Advanced raw import.
...
- Verification: In Playwright, opened Advanced raw import and verified the console helper renders, the console snippet is populated, and the Copy Console Code button is present/clickable.
